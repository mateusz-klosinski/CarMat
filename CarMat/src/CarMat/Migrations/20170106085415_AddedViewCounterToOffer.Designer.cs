...
namespace CarMat.Migrations
{
    ...
    [Migration("20170106085415_AddedViewCounterToOffer")]
    partial class AddedViewCounterToOffer
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CarMat.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CarMat.Models.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CarMat.Models.UserNotification", b =>
                {
                    b.HasOne("CarMat.Models.Notification", "Notification")
                        .WithMany("Users")
